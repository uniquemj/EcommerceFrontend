...
import { useResendVerificationEmail, useVerifyCustomerEmail } from "@/hooks/customer.hooks";
...
export const Route = createFileRoute("/auth/(customer)/verify/$code")({
  component: RouteComponent,
});

function RouteComponent() {
  const { code } = Route.useParams();
  const { isPending, mutate } = useVerifyCustomerEmail();
