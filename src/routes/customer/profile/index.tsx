          ...
          <div className='flex flex-col gap-6'>
            <div className='flex flex-col space-y-1 text-center gap-2'>
              ...
              }
              {
                ...
                <h1 className='text-sm min-[460px]:text-md font-medium text-gray-400'>DOB: {customer.data.date_of_birth.split('T')[0]}</h1>:null
              }
            ...
            <div className='flex gap-2'>
              <Link to='/customer/profile/update'>
                <Button className='bg-red-400 '>Edit profile</Button>
              </Link>
              <Link to='/customer/update-password'>
                <Button className='bg-red-400 '>Update Password</Button>
              </Link>
            </div>
          </div>
        </div>
